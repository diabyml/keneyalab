...
function getQueryOptions(sf: StatusFilter) {
  return {
    queryKey: ["specimen-types", { includeDeleted: sf }],
    queryFn: () =>
      SpecimenTypesService.readSpecimenTypes({
        limit: 200,
...
export function TypesPrelevementView() {
        ...
        <div className="rounded-lg border bg-card p-4">
          <div className="flex flex-wrap items-end gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              >
                <SelectTrigger id="filter-status-st" size="sm" className="w-44">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
