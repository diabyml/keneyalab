...
import { MotifRejetDialog } from "./MotifRejetDialog"

type StatusFilter = "active" | "deleted" | "all"
function getQueryOptions(sf: StatusFilter) {
  return {
    queryKey: ["rejection-reasons", { includeDeleted: sf }],
    queryFn: () =>
      RejectionReasonsService.readRejectionReasons({
        limit: 200,
...
export function MotifsRejetView() {
        ...
        <div className="rounded-lg border bg-card p-4">
          <div className="flex flex-wrap items-end gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              >
                <SelectTrigger id="filter-status-rr" size="sm" className="w-44">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
  ...
  if (filtered.length === 0)
    return (
      <Empty>
        ...
        <EmptyTitle>Aucun motif trouvé</EmptyTitle>
        <EmptyDescription>
