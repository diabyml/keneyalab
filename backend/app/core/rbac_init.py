...
SEED_PERMISSIONS: list[dict] = [
    ...
    # Reagents
    {
        "resource": "reagents",
        "action": "view",
        "description": "View reagent stock and alerts",
    },
    {
        "resource": "reagents",
        "action": "manage",
        "description": "Create, edit, delete, and restore reagents and lots",
    },
    {
        "resource": "reagents",
        "action": "record_movement",
        "description": "Record reagent stock usage, adjustment, and disposal",
    },
    {
        "resource": "reagents",
        "action": "manage_settings",
        "description": "Manage reagent alert settings",
    },
...
ROLE_PERMISSION_MAP: dict[str, list[tuple[str, str]]] = {
    ...
    "lab_manager": [
        ...
        ("reagents", "view"),
        ("reagents", "manage"),
        ("reagents", "record_movement"),
        ("reagents", "manage_settings"),
        ("items", "create"),
        ("items", "view"),
        ("items", "edit"),
        ("items", "delete"),
