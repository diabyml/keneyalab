    ...
    op.execute(
        ...
        VALUES
            ('54444444-4444-4444-8444-444444444444',
             ...
             '.report-category{margin:18px 0}.report-category h2{font-size:14px;color:#0f766e;border-bottom:1px solid #cbd5e1;padding-bottom:6px}.clinical-table{width:100%;border-collapse:collapse;font-size:11px}.clinical-table th,.clinical-table td{padding:7px 6px;border-bottom:1px solid #e2e8f0;text-align:left}.clinical-table th{color:#475569;font-weight:600}.result-abnormal{font-weight:700;color:#b45309}.result-critical{font-weight:800;color:#b91c1c}',
             NOW())
        ON CONFLICT (id) DO NOTHING;
